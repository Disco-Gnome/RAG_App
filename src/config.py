...
APP_NAME = "You chat with me using your own files as context."
...
STOP_WORD_LIST = ['what', 'are', 'is', 'the', 'of', 'in', 'to', 'and', 'a', 'for', 'on', 'with', 'how', 'that', 'by', 'as', 'from', 'this', 'at', 'an', 'be', 'it', 
                          ...
                          'can', 'may', 'might', 'must', 'shall', 'do', 'does', 'did', 'done', 'am', 'was', 'were', 'been', 'being', 'have', 'has', 'had', 'having', 'who', 'whom',
                          'whose', 'when', 'where', 'why', 'about', 'into', 'through', 'during', 'before', 'after', 'above', 'below', 'between', 'up', 'down', 'out', 'off', 'over',
                          'under', 'again', 'further', 'once', 'here', 'both', 'either', 'neither', 'nor'
                  ]